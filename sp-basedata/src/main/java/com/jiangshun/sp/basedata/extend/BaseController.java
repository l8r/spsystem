...
//		return CookieUtils.getCookie(systemConstant.getCookiename(), getHttpServletRequest());
//	}
//
//	/**
//	 * 获取当前登录用户信息
...
//				Integer.valueOf(claims.get("usertype") == null ? "-1" : claims.get("usertype").toString()));
//		userinfo.setUserid(Long.valueOf(claims.get("userid") == null ? "0" : claims.get("userid").toString()));
//		userinfo.setCompanyid(Long.valueOf(claims.get("companyid") == null ? "0" : claims.get("companyid").toString()));
//		userinfo.setSystemid(claims.get("companyid") == null ? null : claims.get("systemid").toString());
...
//		Claims claims = JwtUtils.getClaimsFromToken(token, systemConstant.getSystemsecretkey());
//
//		if (claims == null) {
//			CookieUtils.removeCookie(getHttpServletRequest(), getHttpServletResponse(), systemConstant.getCookiename());
//			RedicertLogin();
//			return null;
//		}
//
...
//	 * @throws IOException
//	 */
//	protected void RedicertLoginWithParams(Map<String, String> params) throws IOException {
