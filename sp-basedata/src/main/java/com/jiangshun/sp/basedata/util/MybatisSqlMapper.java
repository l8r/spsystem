...
import com.jiangshun.sp.basedata.extend.Action;
import com.jiangshun.sp.basedata.extend.SystemExcute;

public class MybatisSqlMapper {
	private final MappedStatementUtils msUtils;
	private final SqlSession sqlSession;

	public void Action(Action action) {
		try {
			SystemExcute.ExcuteServiceException(action);
		} catch (Exception e) {
	...
	public <T> T Func(Callable<T> func) throws Exception {
		T result = null;
		Exception exception = null;
		try {
			result = SystemExcute.ExcuteServiceException(func);
		} catch (Exception e) {
			exception = e;
		} finally {
			this.close();
	 ...
	 * @param sqlSession
	 */
	public MybatisSqlMapper(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
		this.msUtils = new MappedStatementUtils(sqlSession.getConfiguration());
	}
	...
	public List<Map<String, Object>> selectList(String sql, Object value) {
		...
		List<Map<String, Object>> result = sqlSession.selectList(msId, value);
		return result;
	...
	public class MappedStatementUtils {
		...
		MappedStatementUtils(Configuration configuration) {
